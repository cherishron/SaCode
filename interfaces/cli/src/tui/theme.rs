...
pub(super) struct ThemePalette {
    ...
    pub(super) bg_elevated: Color,
    pub(super) border: Color,
    pub(super) border_strong: Color,
...
impl ThemePalette {
    pub(super) fn github() -> Self {
        Self {
            ...
            border_strong: Color::Rgb(48, 54, 61),
            ...
            git_branch: Color::Rgb(52, 211, 153),
            code: Color::Rgb(121, 192, 255),
    ...
    pub(super) fn vscode() -> Self {
        Self {
            ...
            bg_elevated: Color::Rgb(37, 37, 38),
            border: Color::Rgb(60, 60, 60),
            border_strong: Color::Rgb(82, 82, 82),
            ...
            git_branch: Color::Rgb(78, 201, 176),
            code: Color::Rgb(156, 220, 254),
            selected_fg: Color::Rgb(255, 255, 255),
    ...
    pub(super) fn idea() -> Self {
        Self {
            ...
            bg_elevated: Color::Rgb(60, 63, 65),
            border: Color::Rgb(74, 74, 74),
            border_strong: Color::Rgb(96, 99, 102),
            ...
            git_branch: Color::Rgb(166, 194, 97),
            code: Color::Rgb(104, 151, 187),
            selected_fg: Color::Rgb(255, 255, 255),
