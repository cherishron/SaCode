...
6. `guides/vscode-extension.md` — VSCode 扩展安装、daemon 自动管理与排障
7. `reference/command-reference.md` — CLI / TUI 命令速查
8. `reference/API.md` — 工具系统、Daemon、MCP 接口总览
9. `reference/daemon-api.md` — daemon HTTP、SSE、审批与重连协议
10. `reference/architecture.md` — 分层架构与执行链路
11. `reference/development.md` — 本地开发与测试
12. `product/PRD.md` — 产品定位与能力全景
...
- `guides/vscode-extension.md`：VSCode 扩展安装、配置、daemon 自动管理、审批与 SSE 排障
...
- `plans/project-knowledge-system-implementation-plan.md`：知识沉淀系统实施清单（参见 [project-knowledge-system-plan.md](plans/project-knowledge-system-plan.md)）
